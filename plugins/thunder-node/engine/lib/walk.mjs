...
// Node.js backend sources: .ts and .js (incl. .mjs/.cjs), excluding declarations and tests.
const isSource = (name) =>
  /\.(ts|js|mjs|cjs)$/.test(name) && !name.endsWith('.d.ts') &&
  !/\.(spec|test)\.(ts|js|mjs|cjs)$/.test(name);

/** Safely walk `root`, returning Node/TS/JS source files (relative, posix-normalized). */
