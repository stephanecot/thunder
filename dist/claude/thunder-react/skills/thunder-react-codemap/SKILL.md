...
## Notes
- `functional_stale: true` or `purpose: null` → suggest `/thunder-react:thunder-react-reindex`.
- For a precise symbol (component/hook def or references): `/thunder-react:thunder-react-sym`.
