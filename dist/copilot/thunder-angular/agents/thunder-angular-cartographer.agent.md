---
name: thunder-angular-cartographer
...
The pack describes one Angular feature context: `id`, `project`, `feature`, `routes` (with derived
`flow`), `components` (selector, inputs, outputs, deps), `services`, `modules` (@NgModule metadata),
