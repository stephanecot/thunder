...
| [`thunder-angular`](./plugins/thunder-angular) | Angular / TypeScript | `0.1.13` | 5 — granularity, functional guards + HTTP (R2), ≥50-query sweep, Tier-3 | ⭐⭐⭐ Mature |
| [`thunder-python`](./plugins/thunder-python) | Python (FastAPI / Flask / Django / plain) | `0.1.7` | 3 — multi-framework detection, Tier-3 | ⭐⭐ Stable |
| [`thunder-node`](./plugins/thunder-node) | Node.js backend (Express / Fastify / NestJS) | `0.0.5` | 2 — initial (multi-framework) | ⭐ New |
| [`thunder-react`](./plugins/thunder-react) | React.js (components / hooks / React Router) | `0.0.4` | 2 — initial | ⭐ New |
